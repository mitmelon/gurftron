...
// Run with: scarb test and test it file
...
mod tests {
    ...
    fn test_felt252_reset() {
        ...
        'test_felt252_reset passed'.print();
    }
    ...
    fn test_bytearray_reset() {
        ...
        'test_bytearray_reset passed'.print();
    }
    ...
    fn test_contract_address_reset() {
        ...
        'test_contract_address_reset passed'.print();
    }
    ...
    fn test_option_reset() {
        ...
        'test_option_reset passed'.print();
    }

    #[test]
    fn test_vec_reset() {
        let mut vec: Vec<felt252> = VecTrait::new();
        vec.append(1);
        vec.append(2);
        vec.append(3);
        
        let reset_vec = vec.g_reset();
        assert(reset_vec.len() == 0, 'Vec should reset to empty');
        'test_vec_reset passed'.print();
    }
    ...
    fn test_array_reset() {
        ...
        'test_array_reset passed'.print();
    }

    #[test]
    fn test_g_assert_true() {
        g_assert(true, "This should not panic");
        'test_g_assert_true passed'.print();
    }
    ...
    fn test_g_convert_creation() {
        ...
        let str_val = g_convertTrait::new("Hello");
        
        'test_g_convert_creation passed'.print();
    }
    ...
    fn test_felt252_conversion() {
        ...
        'test_felt252_conversion passed'.print();
    }
    ...
    fn test_u8_conversion() {
        ...
        'test_u8_conversion passed'.print();
    }
    ...
    fn test_bool_conversion() {
        ...
        'test_bool_conversion passed'.print();
    }
    ...
    fn test_cross_type_conversion() {
        ...
        'test_cross_type_conversion passed'.print();
    }
    ...
    fn test_to_string_conversions() {
        ...
        'test_to_string_conversions passed'.print();
    }
    ...
    fn test_numeric_to_conversions() {
        ...
        let result2 = val2.to(val1);
        assert(result2 == 10, 'Numeric conversion 2 failed');
        
        'test_numeric_to_conversions passed'.print();
    }
    ...
    fn test_bool_numeric_conversions() {
        ...
        let false_result = false_val.to(true_val);
        assert(false_result == 0, 'False should convert to 0');
        
        'test_bool_numeric_conversions passed'.print();
    }
    ...
    fn test_u256_conversions() {
        ...
        let result = large_val.to(small_val);
        assert(result == 1000, 'U256 conversion failed');
        
        'test_u256_conversions passed'.print();
    }
    ...
    fn test_contract_address_conversion() {
        ...
        assert(converted == addr, 'ContractAddress conversion failed');
        'test_contract_address_conversion passed'.print();
    }
    ...
    fn test_type_conversions_between_numeric_types() {
        ...
        'test_type_conversions_between_numeric_types passed'.print();
    }
    ...
    fn test_numeric_to_bool_conversions() {
        ...
        'test_numeric_to_bool_conversions passed'.print();
    }
    ...
    fn test_all_numeric_string_conversions() {
        ...
        assert(u64_val.to_string() == "18446744073709551615", 'U64 string conversion failed');
        
        'test_all_numeric_string_conversions passed'.print();
    }
    ...
    fn test_integration_reset_and_convert() {
        ...
        let as_string = dynamic_reset.to_string();
        assert(as_string == "0", 'Reset value should be "0" as string');
        
        'test_integration_reset_and_convert passed'.print();
    }
    ...
    fn test_edge_cases() {
        ...
        let zero_result = zero_u256.to(zero_u256);
